  ...
  return (
    ...
    >
      <div className="hidden xl:flex space-x-4 justify-center w-full">
        ...
        <Link to="/fale-conosco" className="link-navbar">
          FALE CONOSCO
        </Link>
        <Link to="/informacoes" className="link-navbar">
          INFORMAÇÕES E FAQs
        </Link>
        <Link to="/regulamento" className="link-navbar">
          POLÍTICAS E REGULAMENTOS
        </Link>
        {permissao && (
          <>
            <div className="border-r"></div>
            <Link to="/admin/gerenciar" className="link-navbar">
              GERENCIAR
            </Link>
            <Link to="/admin/acompanhamento" className="link-navbar">
              ACOMPANHAMENTO
            </Link>
          </>
        )}
