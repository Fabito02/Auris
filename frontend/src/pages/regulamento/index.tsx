    ...
    <div>
      ...
      <div className="regulamento-container">
        ...
        <div className="welcome-message">
          Seja bem-vindo(a) à página de Regulamento da Ouvidoria Digital do IFNMG - Campus Almenara.
        </div>
...
<p><h2><strong>Art. 4º.</strong> São objetivos do serviço de Ouvidoria do IFNMG - Campus Almenara:</h2></p>
<ul>
...
<p><h2><strong>Art. 5º.</strong> Compete à Ouvidoria do IFNMG - Campus Almenara:</h2></p>
<ul>
...
<p><h2><strong>Art. 7º.</strong> São deveres do Ouvidor:</h2></p>
<ul>
...
<p><h2><strong>Art. 8º.</strong> São atribuições do Ouvidor:</h2></p>
<ul>
...
<p><h2><strong>Art. 9º.</strong> Constituem motivos para a destituição do Ouvidor:</h2></p>
<ul>
...
<p><h2><strong>Art. 10º.</strong> A Ouvidoria pode ser utilizada:</h2></p>
<ul>
...
<p><h2><strong>Art. 11º.</strong> Todas as solicitações são documentadas em ordem cronológica, contendo:</h2></p>
<ul>
...
<p><h2><strong>Art. 15º.</strong> A divulgação conterá os seguintes dados gerais:</h2></p>
<ul>
