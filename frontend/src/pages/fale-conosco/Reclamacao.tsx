...
const Reclamacao = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const data = {
      Anonimo: anonimo,
      Tipo_manifestacao: "reclamacao" as "reclamacao",
      Tipo: tipo,
      Titulo: titulo,
    ...
    try {
      ...
      toast.error(
        error.response?.data?.error ||
          error.message ||
          "Erro ao enviar a reclamação. Tente novamente mais tarde.",
        {
          icon: (
            <Icon
              icon="mdi:alert-circle"
        ...
        >
          <div>
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <p className="text-sm text-red-500 my-4">
                  *OBS: Estas informações serão usadas para entrar em contato
                  com você. Reclamações identificadas permitem um acompanhamento
                  mais eficaz.
                </p>
              </CardContent>
              <CardHeader>
                <CardTitle>Tipo de Reclamação</CardTitle>
                <CardDescription>
                  Selecione o tipo da sua reclamação.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-2">
              ...
              <CardHeader>
                <CardTitle>Descrição da reclamação</CardTitle>
                <CardDescription>
                  Descreva o motivo e contexto da reclamação.
                </CardDescription>
              </CardHeader>
