...
const Sugestao = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const data = {
      Anonimo: anonimo,
      Tipo_manifestacao: "sugestao" as "sugestao",
      Tipo: tipo,
      Titulo: titulo,
    ...
    try {
      ...
      toast.error(
        error.response?.data?.error ||
          error.message ||
          "Erro ao enviar a sugestão. Tente novamente mais tarde.",
        {
          icon: (
            <Icon
              icon="mdi:alert-circle"
          ...
          <div>
            <Card>
              ...
              <CardContent className="space-y-2">
                <Select name="tipo" onValueChange={(value) => setTipo(value)}>
                  ...
                  <SelectContent className="custom-select-content">
                    ...
                    <SelectItem value="Serviços Acadêmicos">
                      Serviços Acadêmicos
                    </SelectItem>
                    <SelectItem value="Atendimento">Atendimento</SelectItem>
                    <SelectItem value="Tecnologia e Sistemas">
                      Tecnologia e Sistemas
                    </SelectItem>
                    <SelectItem value="Infraestrutura de TI">
                      Infraestrutura de TI
                    </SelectItem>
                    <SelectItem value="Higiene e Limpeza">
                      Higiene e Limpeza
                    </SelectItem>
                    ...
                    <SelectItem value="Eventos e Atividades">
                    ...
                    <SelectItem value="Inclusão e Diversidade">
                      Inclusão e Diversidade
                    </SelectItem>
                    <SelectItem value="Atividades Culturais">
                      Atividades Culturais
                    </SelectItem>
                    <SelectItem value="Infraestrutura Esportiva">
                      Infraestrutura Esportiva
                    </SelectItem>
                    <SelectItem value="Bem-Estar Estudantil">
                      Bem-Estar Estudantil
                    </SelectItem>
                    <SelectItem value="Suporte Psicológico">
                      Suporte Psicológico
                    </SelectItem>
                    <SelectItem value="Políticas de Estágio">
                      Políticas de Estágio
                    </SelectItem>
                    <SelectItem value="Processos Administrativos">
              ...
              <CardHeader>
                ...
                <CardDescription>
                  Descreva o motivo e contexto da sugestão.
                </CardDescription>
              </CardHeader>
