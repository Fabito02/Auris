...
router.get("/manifestacoes/:id", verifyToken, verifyRole(["admin", "moderador"]), manifestacaoController.getMinhaManifestacao);
router.get("/me/manifestacoes/:id", verifyToken, manifestacaoController.responderManifestacao);
